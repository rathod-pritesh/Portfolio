...
{:else}
  ...
  {#if success}
    <div
      class="flex items-center gap-2 bg-green-500/[0.08] border border-green-500/20
  ...
  {#if error}
    <div
      class="flex items-center gap-2 bg-red-500/[0.08] border border-red-500/20
  ...
  <!-- form -->
  <div
    class="bg-dark border border-white/[0.07] rounded-2xl p-6 sm:p-8
  ...
  >
    <div class="flex flex-col gap-6">
      ...
      <div class="flex flex-col gap-1.5">
        ...
        <div class="relative">
          <i
            class="fa-solid fa-link absolute left-3.5 top-1/2 -translate-y-1/2
                    text-sm text-white/25 pointer-events-none"
          ></i>
          <input
            type="url"
            id="resumeUrl"
        ...
        {#if form.resumeUrl}
          <a
            ...
            class="inline-flex items-center gap-1.5 text-xs text-primary/70
      ...
      <div class="flex flex-col gap-1.5">
        ...
        <div class="flex items-start gap-4">
          ...
          <div class="relative flex-1">
            <i
              class="fa-solid fa-image absolute left-3.5 top-1/2 -translate-y-1/2
                      text-sm text-white/25 pointer-events-none"
            ></i>
            <input
              id="profileImage"
          ...
          {#if form.profileImage}
            <div
              class="shrink-0 w-14 h-14 rounded-xl border border-white/10 overflow-hidden bg-darker"
            >
              <img
          ...
          {:else}
            <div
              class="shrink-0 w-14 h-14 rounded-xl border border-white/10
    ...
    <!-- Divider -->
    <div
      class="border-t border-white/[0.06] mt-8 pt-6 flex items-center justify-between gap-4 flex-wrap"
    >
